...
const collateralFactor = 0 // 0% LTV as we are not allowing anyone to use USDC as collateral
const currentPrice = 10 ** 30 // Compound oracles account for decimals. $1 * 10^18 * 10^18 / 10^6 (USDC decimals)
